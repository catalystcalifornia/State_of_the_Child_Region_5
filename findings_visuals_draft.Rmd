...
Foreclosure data was calcuated using 2017 to partial 2022 data. In this time period there were a total of 546 foreclosures. On average 0.01% of 10,000 households in the AV faced foreclosures during this time period. By rate, Lake Los Angeles had the most foreclosures where 0.6% out of 10,000 households faced foreclosures while Palmdale had the least (0.02%). Similary Lancaster also faced a small rate of foreclosures (0.04%). However count wise, because of the Lancaster and Palmdale having the greatest population in the AV, by count they still had the most foreclosures, 239 and 181 respectively.
