...
Source: [California Department of Education, 2021-2022](https://dq.cde.ca.gov/dataquest/)
...
The average high school graduation rate in the Antelope Valley is 46.9%. In the AV, Latinx (43.8%) followed by Black (44%) students had the lowest graduation rates while Asian (71.6%) and Filipino (70.3%) students had the highest. The Acton-Agua Dulce Unified School District has the lowest graduation rate (34.7%). Notably in the Acton-Agua Dulce Unified School District Latinx, Black, Filipino, and students who identified as non-Hispanic Two or More Races all had under 50% graduation rates. The Gorman Joint School District had the highest rate (81.9%). 
...
# create english / spanish labels
engvar = c("Asian", "Black", "Filipino", "Latinx", "Two or More Races", "White")
esvar = c("Asiático", "Negro", "Filipino", "Latino", "Dos o Mas Razas",  "Blanco")
#esvar_long = c("ASIÁTICO", "NEGRO O AFROAMERICANO", "LATINO", "OTRA RAZA","BLANCO")
labels <- data.frame(engvar, esvar)
# labels
