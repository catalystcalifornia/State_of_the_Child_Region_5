...
av_table$"Asian"[av_table$"Asian"=="88.0"] <- '88'
av_table$"Black"[av_table$"Black"=="797.0"] <- '797'
av_table$"Filipino"[av_table$"Filipino"=='67.0'] <- '67'
av_table$"Latinx"[av_table$"Latinx"=='3539.0'] <- '3539'
av_table$"Two or More Races"[av_table$"Two or More Races"=="234.0"] <- '234'
av_table$"White"[av_table$"White"=="843.0"] <- '843'
