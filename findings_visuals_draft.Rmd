...
av_plot <- ggplot(df_chart, aes(x=NEIGHBORHOOD, y=Rent_Burdened))+
  ...
  geom_bar(stat = "identity", position = position_dodge(0.7), show.legend = FALSE) +
  labs(title = "High School Graduation Rates (%)", subtitle = region) +
...
Source: [California Department of Education, Adjusted Cohort Graduation Rate and Outcome Data, 2015-2022](https://www.cde.ca.gov/ds/ad/filesacgr.asp)
