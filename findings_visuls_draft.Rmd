...
```{r}
kbl(total_grade_only) %>%
  kable_styling(bootstrap_options = c("striped", "bordered", "condensed"))
```
  

```{r}
kbl(lancaster_race_only) %>%
  kable_styling(bootstrap_options = c("striped", "bordered", "condensed"))
```
...
```{r}
kbl(palmdale_race_only) %>%
  kable_styling(bootstrap_options = c("striped", "bordered", "condensed"))
```


```{r}
kbl(westside_race_only) %>%
  kable_styling(bootstrap_options = c("striped", "bordered", "condensed"))
```


```{r}
kbl(eastside_race_only) %>%
  kable_styling(bootstrap_options = c("striped", "bordered", "condensed"))
```
