...
gtsave(suspensions, "suspensions_table_check.png",path = "W:/Project/RDA Team/Region 5 State of the Child/GitHub/AB/State_of_the_Child_Region_5/Images/English/", vwidth = 4000, vheight = 6000)
...
susp_table$`Grupo de estudiantes` <- gsub("Pacific Islander", "Isleñx del Pacífico (Isleño del Pacífico)",susp_table$`Grupo de estudiantes`)
susp_table$`Grupo de estudiantes` <- gsub("Male", "Hombre",susp_table$`Grupo de estudiantes`)
susp_table$`Grupo de estudiantes` <- gsub("Socioeconomically Disadvantaged", "Desfavorecido socioeconómicamente",susp_table$`Grupo de estudiantes`)
susp_table$`Grupo de estudiantes` <- gsub("Two or More Races", "Dos o más razas",susp_table$`Grupo de estudiantes`)
...
susp_table$`Grupo de estudiantes` <- gsub("English Learners", "Estudiantes de inglés",susp_table$`Grupo de estudiantes`)
...
susp_table$`Grupo de estudiantes` <- gsub("Asian", "Asiáticx (Asiático)",susp_table$`Grupo de estudiantes`)
...
suspensions <- susp_table %>%
  mutate(across(c(`Matrícula de estudiantes`, `Conteo no duplicado de estudiantes suspendidos`), comma)) %>%
  gt() %>% opt_all_caps() %>% 
  tab_header(title = md("**Tasas de suspensión por grupo de estudiantes, distritos escolares de Antelope Valley, 2021-22**")) %>% 
  tab_footnote (footnote = md("Fuente: Cálculos de Catalyst California de datos del Departamento de Educación de California, 2021-22.<br>
                                Nota: La categoría de grupo de estudiantes para estudiantes género neutral, no estaba disponible debido 
                              ...
                              Wilsona.  AIAN (por sus siglas en inglés) significa Indix Americanx y Nativx de Alaska (Indio Americano y 
  ...
  opt_table_font(font = list(google_font(name = font_table_text), font_title, font_caption ,default_fonts()))
gtsave(suspensions, "suspensions_table_esp_check.png",path = "W:/Project/RDA Team/Region 5 State of the Child/GitHub/AB/State_of_the_Child_Region_5/Images/Spanish/", vwidth = 4000, vheight = 6000)
