# Calculate ELA scores for AV school districts

# source: "CAASPP 2021-22 https://caaspp-elpac.cde.ca.gov/caaspp/ResearchFileListSB?ps=true&lstTestYear=2021&lstTestType=B&lstCounty=00&lstDistrict=00000. Students scoring proficient or better on 3rd grade English Language Arts (%)."
...
# entities <- read.delim2("W:\\Personal\\Alex\\sb_ca2022entities_ascii.txt", header = FALSE, sep = "\t", dec = ".")
# Attempt to change data loaded -----
...
df_subset <- df %>% filter( grade == "03" & geoname == 'Los Angeles' & test_id == "01" & indicator %in% c("001","074","075","076","077","078","079","080","144","128","031","160","028","240","003","004","052")
                          & type_id %in% c("06")) %>%  
