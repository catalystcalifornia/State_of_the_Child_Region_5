# CDE Data for Socioeconomically Disadvantaged Students
# source: CDE 2021-22 https://dq.cde.ca.gov/dataquest/. Socioeconomically Disadvantaged Students rates 2021-22. Subgroups with total enrollment under 10 are excluded from the calculations. Non-binary Students rate calculated as percent of enrollment for each subgroup
...
## CDE Socioeconomically Disadvantaged Students at the School District level ##
library(openxlsx)
library(dplyr)
library(janitor)
...
av_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
av_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Antelope Valley Union Joint High School District",type = "enroll")
av_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Antelope Valley Union Joint High School District",type = "indicator")
...
eu_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
eu_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Eastside Union Elementary School District",type = "enroll")
eu_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Eastside Union Elementary School District",type = "indicator")
...
wu_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
wu_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Westside Union Elementary School District",type = "enroll")
wu_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Westside Union Elementary School District",type = "indicator")
...
palm_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
palm_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Palmdale Elementary School District",type = "enroll")
palm_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Palmdale Elementary School District",type = "indicator")
...
lan_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
lan_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Lancaster Elementary School District",type = "enroll")
lan_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Lancaster Elementary School District",type = "indicator")
...
acton_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
acton_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Acton-Agua Dulce Unified School District",type = "enroll")
acton_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Acton-Agua Dulce Unified School District",type = "indicator")
...
wilsona_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
wilsona_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Wilsona Elementary School District",type = "enroll")
wilsona_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Wilsona Elementary School District",type = "indicator")
...
keppel_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
keppel_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
 mutate(geoname = "Keppel Union Elementary School District",type = "enroll")
keppel_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
 mutate(geoname = "Keppel Union Elementary School District",type = "indicator")
...
hughes_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Grade.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
hughes_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Hughes-Elizabeth Lakes Union Elementary School District",type = "enroll")
hughes_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Race.xlsx", sheet=2, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Hughes-Elizabeth Lakes Union Elementary School District",type = "indicator")
