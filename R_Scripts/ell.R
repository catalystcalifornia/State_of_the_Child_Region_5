# Calculate ELL rates for AV school districts
# source: "CDE 2021-22 https://dq.cde.ca.gov/dataquest/. English Language Learner Student rates 2021-22. Subgroups with total enrollment under 10 are excluded from the calculations. ELL Students rate calculated as percent of enrollment for each subgroup
...
## CDE Student ELL for School District ##
library(openxlsx)
library(dplyr)
library(janitor)
...
av_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
av_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Antelope Valley Union Joint High School District",type = "enroll")
av_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Antelope Valley Union Joint High School District",type = "indicator")
...
eu_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
eu_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Eastside Union Elementary School District",type = "enroll")
eu_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Eastside Union Elementary School District",type = "indicator")
...
wu_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
wu_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Westside Union Elementary School District",type = "enroll")
wu_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Westside Union Elementary School District",type = "indicator")
...
palm_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
palm_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Palmdale Elementary School District",type = "enroll")
palm_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Palmdale Elementary School District",type = "indicator")
...
lan_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
lan_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Lancaster Elementary School District",type = "enroll")
lan_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Lancaster Elementary School District",type = "indicator")
...
acton_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
acton_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Acton-Agua Dulce Unified School District",type = "enroll")
acton_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Acton-Agua Dulce Unified School District",type = "indicator")
...
wilsona_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
wilsona_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Wilsona Elementary School District",type = "enroll")
wilsona_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Wilsona Elementary School District",type = "indicator")
...
keppel_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
keppel_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
 mutate(geoname = "Keppel Union Elementary School District",type = "enroll")
keppel_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
 mutate(geoname = "Keppel Union Elementary School District",type = "indicator")
...
hughes_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Grade.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
hughes_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Hughes-Elizabeth Lakes Union Elementary School District",type = "enroll")
hughes_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Race.xlsx", sheet=11, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Hughes-Elizabeth Lakes Union Elementary School District",type = "indicator")
...
# since we are just using raw tables right now, this step is somewhat extraneous, 
# however I included it in case we decided to use static mapping to visualize it 
# for this indicator in the report. The rest of the steps could have been done without this step.
df_wide <- cde_geoid(df)

####### clean and transform the raw csv data ----

#make sure there are no clearly wrong negative values. 
#Initially at the county level, this threshold was set to 20, 
#but since there are much smaller numbers at the district level, I essentially removed the screen.
raw_threshold <- 0 
...
race_2016 <- race_subset %>% filter(year=="2015-16") %>% # filter by year so that sums are by single year only
  adorn_totals("row") %>% # sum the numerical values to create a total column row
  mutate(year = "2015-16", geoid = ifelse(geoid=="-", 'Total', geoid)) # add the year column back in that disappeared when we filtered earlier. Also rename "-" to "Total" so we know what that row is. and so the wording matches the function that I created

race_2017 <- race_subset %>% filter(year=="2016-17") %>% 
  adorn_totals("row") %>% 
  mutate(year = "2016-17", geoid = ifelse(geoid=="-", 'Total', geoid))

race_2018 <- race_subset %>% filter(year=="2017-18") %>% 
  adorn_totals("row") %>% 
  mutate(year = "2017-18", geoid = ifelse(geoid=="-", 'Total', geoid))

race_2019 <- race_subset %>% filter(year=="2018-19") %>% 
  adorn_totals("row") %>% 
  mutate(year = "2018-19", geoid = ifelse(geoid=="-", 'Total', geoid))

race_2020 <- race_subset %>% filter(year=="2019-20") %>% 
  adorn_totals("row") %>% 
  mutate(year = "2019-20", geoid = ifelse(geoid=="-", 'Total', geoid))

race_2021 <- race_subset %>% filter(year=="2020-21") %>% 
  adorn_totals("row") %>% 
  mutate(year = "2020-21", geoid = ifelse(geoid=="-", 'Total', geoid))

race_2022 <- race_subset %>% filter(year=="2021-22") %>% 
  adorn_totals("row") %>% 
  mutate(year = "2021-22", geoid = ifelse(geoid=="-", 'Total', geoid))
...
grade_2016 <- grade_subset %>% filter(year=="2015-16") %>% adorn_totals("row") %>% mutate(year = "2015-16", geoid = ifelse(geoid=="-", 'Total', geoid))
grade_2017 <- grade_subset %>% filter(year=="2016-17") %>% adorn_totals("row") %>% mutate(year = "2016-17", geoid = ifelse(geoid=="-", 'Total', geoid))
grade_2018 <- grade_subset %>% filter(year=="2017-18") %>% adorn_totals("row") %>% mutate(year = "2017-18", geoid = ifelse(geoid=="-", 'Total', geoid))
grade_2019 <- grade_subset %>% filter(year=="2018-19") %>% adorn_totals("row") %>% mutate(year = "2018-19", geoid = ifelse(geoid=="-", 'Total', geoid))
grade_2020 <- grade_subset %>% filter(year=="2019-20") %>% adorn_totals("row") %>% mutate(year = "2019-20", geoid = ifelse(geoid=="-", 'Total', geoid))
grade_2021 <- grade_subset %>% filter(year=="2020-21") %>% adorn_totals("row") %>% mutate(year = "2020-21", geoid = ifelse(geoid=="-", 'Total', geoid))
grade_2022 <- grade_subset %>% filter(year=="2021-22") %>% adorn_totals("row") %>% mutate(year = "2021-22", geoid = ifelse(geoid=="-", 'Total', geoid))
...
# visualizations Prep ----
total_grade_only <- grade_all %>% filter(geoid == 'Total')

race_2022 <- race_all %>% filter(year == '2021-22') %>% dplyr::select(-year)

# tables used in the draft visuals doc
av_table <- race_2022 %>% 
