# 
# source: CDE 2021-22 https://dq.cde.ca.gov/dataquest/. Non-binary Students rates 2021-22. Subgroups with total enrollment under 10 are excluded from the calculations. Non-binary Students rate calculated as percent of enrollment for each subgroup.

# install packages if not already installed
list.of.packages <- c("openxlsx","dplyr","janitor") #,"plyr"
new.packages <- list.of.packages[!(list.of.packages %in% installed.packages()[,"Package"])]
if(length(new.packages)) install.packages(new.packages)

## CDE Non-binary Students for School District ##
library(openxlsx)
library(dplyr)
library(janitor)
...
av_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
av_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Antelope Valley Union Joint High School District",type = "enroll")
av_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Antelope Valley Union High School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Antelope Valley Union Joint High School District",type = "indicator")
...
eu_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
eu_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Eastside Union Elementary School District",type = "enroll")
eu_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Eastside Union Elementary School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Eastside Union Elementary School District",type = "indicator")
...
wu_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
wu_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Westside Union Elementary School District",type = "enroll")
wu_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Westside Union Elementary School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Westside Union Elementary School District",type = "indicator")
...
palm_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
palm_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Palmdale Elementary School District",type = "enroll")
palm_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Palmdale Elementary School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Palmdale Elementary School District",type = "indicator")
...
lan_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
lan_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Lancaster Elementary School District",type = "enroll")
lan_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Lancaster Elementary School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Lancaster Elementary School District",type = "indicator")
...
acton_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
acton_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Acton-Agua Dulce Unified School District",type = "enroll")
acton_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Acton-Agua Dulce Unified School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Acton-Agua Dulce Unified School District",type = "indicator")
...
wilsona_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
wilsona_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Wilsona Elementary School District",type = "enroll")
wilsona_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Wilsona Elementary School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Wilsona Elementary School District",type = "indicator")
...
keppel_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
keppel_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
 mutate(geoname = "Keppel Union Elementary School District",type = "enroll")
keppel_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Keppel Union Elementary School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
 mutate(geoname = "Keppel Union Elementary School District",type = "indicator")
...
hughes_gr_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Grade.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:17))%>% 
...
hughes_race_enrollment = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Race.xlsx", sheet=1, startRow=1, rows=c(1:8), cols=c(1:11))%>% 
  mutate(geoname = "Hughes-Elizabeth Lakes Union Elementary School District",type = "enroll")
hughes_race_indicator = read.xlsx("W:/Project/RDA Team/Region 5 State of the Child/Data/CDE Hughes-Elizabeth Lakes Union Elementary School District by Race.xlsx", sheet=14, startRow=1, rows=c(1:8), cols=c(1:11)) %>% 
  mutate(geoname = "Hughes-Elizabeth Lakes Union Elementary School District",type = "indicator")
...
race_2016 <- race_subset %>% filter(year=="2015-16") %>% adorn_totals("row") %>% mutate(year = "2015-16", geoid = ifelse(geoid=="-", 'Total', geoid))
race_2017 <- race_subset %>% filter(year=="2016-17") %>% adorn_totals("row") %>% mutate(year = "2016-17", geoid = ifelse(geoid=="-", 'Total', geoid))
race_2018 <- race_subset %>% filter(year=="2017-18") %>% adorn_totals("row") %>% mutate(year = "2017-18", geoid = ifelse(geoid=="-", 'Total', geoid))
race_2019 <- race_subset %>% filter(year=="2018-19") %>% adorn_totals("row") %>% mutate(year = "2018-19", geoid = ifelse(geoid=="-", 'Total', geoid))
race_2020 <- race_subset %>% filter(year=="2019-20") %>% adorn_totals("row") %>% mutate(year = "2019-20", geoid = ifelse(geoid=="-", 'Total', geoid))
race_2021 <- race_subset %>% filter(year=="2020-21") %>% adorn_totals("row") %>% mutate(year = "2020-21", geoid = ifelse(geoid=="-", 'Total', geoid))
race_2022 <- race_subset %>% filter(year=="2021-22") %>% adorn_totals("row") %>% mutate(year = "2021-22", geoid = ifelse(geoid=="-", 'Total', geoid))
...
av_table1 <- race_2022 %>% 
  ...
  filter(geoname=="Antelope Valley Best Start Region 5") %>% 
  mutate_at(vars(-geoname), funs(round(., 1))) %>% 
  dplyr::rename("School Year" = "geoname", "Count" = "total_raw", "Rate (%)"="total_rate")
av_table1$"School Year" <- gsub("Antelope Valley Best Start Region 5", "2021-22", av_table1$"School Year") 
...
av_table2 <- race_2021 %>% 
  ...
  mutate_at(vars(-geoname), funs(round(., 1))) %>% 
  dplyr::rename("School Year" = "geoname", "Count" = "total_raw", "Rate (%)"="total_rate")
av_table2$"School Year" <- gsub("Antelope Valley Best Start Region 5", "2020-21", av_table2$"School Year")
